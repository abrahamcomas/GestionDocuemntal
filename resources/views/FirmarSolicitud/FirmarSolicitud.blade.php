                ...
                <div class="col">
                    ...
                    <div class="card bg-light mb-3">
                        ...
                        <div class="table-responsive"> 
                            ...
                            <div class="card-footer text-muted">
                                <form id="F_prestamo" name="F_prestamo" method="POST" action="{{ route('FirmandoSolicitud') }}" accept-charset="UTF-8" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <textarea rows="3" style="width:100%;" disabled> {{$Observacion}} </textarea>
