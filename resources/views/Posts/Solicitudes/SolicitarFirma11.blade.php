...
@section('content')
	<div class="container-fluid">  
		@livewire('solicitudes.solitar-firma11' , ['Ruta' => session('Ruta'), 'FuncionarioSelec' => session('FuncionarioSelec')])    
	</div>  
@endsection     
@section('scripts')
    <script type="text/javascript">  
        ...
        pdfjsLib.getDocument('{{ 'ImagenPDF11/'.session('Ruta') }}').then((pdf) => {
