                ...
                <div class="col">
                    <div class="card bg-light mb-3"> 
                        <div class="text-muted" >
                            <br> 
                            <h1><center><strong>ESTADO USUARIOS</strong></center></h1>
                            <hr>
                        </div> 
                        <div class="card-body">
                        <div class="row">   
                        ...
                        @if($Lista->count())
                            <table table class="table table-hover">
                                ...
                                <tbody>  
                                    ...
                                    @if($post->Activo==1)
                                        <td>
                                            <button class="btn btn-success active btn-info"  wire:click="Activo({{ $post->ID_Funcionario_T }})">ACTIVADO</button>
                                        </td>
                                    @else 
                                        <td>
                                            <button class="btn btn-danger active btn-info"  wire:click="Activo({{ $post->ID_Funcionario_T }})">DESACTIVADO</button>
                                        </td>
                                    @endif
                                    </tr>
                                    @endforeach  
