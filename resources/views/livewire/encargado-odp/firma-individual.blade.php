            ...
            @include('messages')   
                <div class="card bg-light mb-3"> 
                        ...
                        <div class="card-body">  
                            ...
                            <form id="F_prestamo" name="F_prestamo" method="POST" action="{{ route('FirmarArchivoDirectoIndividual') }}" accept-charset="UTF-8" enctype="multipart/form-data">
                                @csrf   
                                <input type="hidden" name="Ruta" value= "{{ session('Ruta') }}">
                                ...
                                <div class="card-footer text-muted">
                                    <div class="btn-group" style=" width:100%;">
                                        <button type="submit" id="btnEnviar1" class="btn btn-success  btn-submit active">ACEPTAR</button>
                                    </div>
                                </div>
                            </form> 
                        <div class="card-footer text-muted">
