            ...
            <div class="col"> 
                <div class="card bg-light mb-3">
                    <div class="text-muted" >
                        <br> 
                        <h1><center><strong>SOLICITUDES COMPARTIDAS {{ $AnioSelect}}</strong></center></h1>
                        <hr>
                    </div>
                    <div class="card-body">  
                        <div class="row">
                                ...
                                @foreach($posts as $post)
                                    <tr>
                                        ...
                                        @endphp
                                            ...
                                            <td> 
                                                <button class="btn btn-success" wire:click="Detalles({{ $post->IPFE_ID }},{{ $post->ID_Documento_T }})">DETALLES</button>
                                            </td>
                                    </tr>
                                @endforeach 
                            </tbody>    
