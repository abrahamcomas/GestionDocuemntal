            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="col">
                    <div class="card bg-light mb-3">  
                        ...
                        <div class="card-body">
                            <center><img src="{{URL::asset('Imagenes/Portafolio/Firmados.JPG')}}" width="1200" height="1200" class="img-fluid" alt="Responsive image"/></center> 
                        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="card bg-light mb-3">
                            ...
                            <div class="card-body table-responsive">
                                <table table class="table table-hover">
                                    ...
                                    <tbody> 
                                        @foreach($DestinoFuncionariosFir as $post)
                                            <tr>
                                                <td>
                                                    {{$post->Nombres }} {{$post->Apellidos }}
                                                </td>
            ...
            @elseif($Cambiar==1)
                                    ...
                                    <tbody> 
                                        @foreach($VistoBueno as $post)
                                            <tr>
                                                ...
                                                @endif
                                                    <td> 
                                                        <button class="btn btn-success" wire:click="ListaFuncionariosVB({{ $post->ID_Documento }})">MOSTRAR</button>
                                                    </td>
                                            </tr>
                                        @endforeach 
                                    <tbody> 
                        ...
                        <div class="card bg-light mb-3">
                            ...
                            <div class="card-body">
                                <table table class="table table-hover">
                                    ...
                                    <tbody> 
                                        @foreach($DestinoFuncionariosVB as $post)
                                            <tr>
                                                <td>
                                                    {{$post->Nombres }} {{$post->Apellidos }}
                                                </td>
                                                <td>
                                                    {{$post->ObservacionResp }}
                                                </td>
                                                <td>
                                                    {{$post->Nombre_DepDir  }}
                                                </td>
                ...
                <div class="card-footer text-muted">
                    <div class="btn-group" style=" width:100%;">	
                        <div class="btn-group" style=" width:50%;">	
                            <button class="btn btn-warning active" wire:click="CambiaEnviados">CAMBIAR</button>
                        </div> 
                        <div class="btn-group" style=" width:50%;">	
                            <button class="btn btn-danger active" wire:click="Volver">VOLVER</button>
                        </div> 
