                ...
                <div class="card bg-light mb-3"> 
                    <div class="card-header"> <h4><strong>SOLICITAR FIRMA DE ARCHIVO</strong></h4></div>
                        <div class="card-body">  
                            ...
                            <form id="F_prestamo" name="F_prestamo" method="POST" action="{{ route('SolicitarFirmaFuncionario11') }}" accept-charset="UTF-8" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="ID_LinkFirma" value= "{{ session('ID_LinkFirma') }}">
                                ...
                                <div class="card-footer text-muted">
                                    <div class="btn-group" style=" width:100%;">
                                        <button type="submit" id="btnEnviar1" class="btn btn-success  btn-submit active">SOLICITAR FIRMA</button>
                                    </div>
                                </div>
                            </form> 
                        <div class="card-footer text-muted">
