...
class Compartidas extends Component
{
    public $Ayuda=0; 
    ...
    public function Detalles($IPFE_ID,$ID_Documento_T)
    {
        $InterPortaFuncionarioEnviado          = InterPortaFuncionarioEnviado::find($IPFE_ID);
        $InterPortaFuncionarioEnviado->Visto   = 1;  
    ...
    public function render()
    {
        ...
        return view('livewire.portafolio.compartidas',[
            'posts' =>  DB::table('Portafolio') 
            ->leftjoin('InterPortaFuncionarioEnviado', 'Portafolio.ID_Documento_T', '=', 'InterPortaFuncionarioEnviado.IPF_Portafolio')
            ...
            ->where('IPF_ID_Funcionario', '=', $this->ID_Funcionario) 
            ...
            ->select('ID_FSube','ID_DestinoDocumento','NombreDocumento')
