...
class FirmaMasiva extends Component
{
    ...
    public function Select($ID_Documento_T){  
        ...
        $FirmaMasiva =  DB::table('Funcionarios')->select('FirmaMasiva')->where('id_Funcionario_T', '=',$ID_Documento_T)->first();


        if($FirmaMasiva->FirmaMasiva==0){
            
            $FuncionarioModels =FuncionarioModels::find($ID_Documento_T);
            $FuncionarioModels->FirmaMasiva               = 1;
            $FuncionarioModels->save();

        }else{
            
            $FuncionarioModels =FuncionarioModels::find($ID_Documento_T);
            $FuncionarioModels->FirmaMasiva               = 0;
            $FuncionarioModels->save();
    ...
    {
        return view('livewire.root.firma-masiva',[
