...
namespace App\Http\Controllers\Recibidos;
...
class FirmandoRecibidoIndiv extends Controller
{ 
        ...
        { 
            ...
            if(empty($responseBody->status))
                { 
                    ...
                    return view('Documentos/DocumentoFirmados2', compact('status'));

                } 
                
                return view('Documentos/DocumentoRecibidos', compact('status'));
        }                                
        else
        {
            return back()
