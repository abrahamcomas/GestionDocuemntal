...
class FirmarSolicitudController11 extends Controller
{
    ...
    {  
        ...
        if($Numero==1){
                    ...
                    $ID_OficinaPartes =  DB::table('DestinoDocumento11') 
                    ->select('Ruta_T')
